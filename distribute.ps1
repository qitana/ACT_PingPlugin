...
# バージョン取得
$version = [System.Diagnostics.FileVersionInfo]::GetVersionInfo("Build\addons\PingOverlay.dll").FileVersion

# フォルダ名
$buildFolder = ".\Build"
$fullFolder = ".\Distribute\PingOverlay-" + $version
